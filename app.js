...
redColor.addEventListener("click", function () {
  ...
  imageCard.style.backgroundImage = 'url("./images/red3.jpg")';
});
...
grayColor[0].addEventListener("click", function () {
  ...
  imageCard.style.backgroundImage = 'url("./images/grey4.jpg")';
});
...
blackColor.addEventListener("click", function () {
  ...
  imageCard.style.backgroundImage = 'url("./images/black1.jpg")';
});
...
whiteColor.addEventListener("click", function () {
  ...
  imageCard.style.backgroundImage = 'url("./images/white2.jpeg")';
});
...
yellowColor.addEventListener("click", function () {
  ...
  imageCard.style.backgroundImage = 'url("./images/yellow.jpg")';
});
